 ...
 * @access Privado (solo admin)
 */
router.get('/dashboard', auth, checkRole('admin'), adminController.getDashboardStats);
 ...
 * @access Privado (solo admin)
 */
router.put('/orders/:orderId/status', auth, checkRole('admin'), adminController.updateOrderStatus);
 ...
 * @access Privado (solo admin)
 */
router.get('/orders/:orderId/history', auth, checkRole('admin'), adminController.getOrderStatusHistory);
